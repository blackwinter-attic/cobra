package COBRA::Export::Gnuplot;

=head1 NAME

COBRA::Export::Gnuplot - Create statistics diagrams using Gnuplot

=head1 VERSION

This documentation refers to COBRA::Export::Gnuplot version 0.0.1
...
###OLD###
lib/Export/Gnuplot.pm:
########################################################################################
#                                                                                      #
# Gnuplot.pm -- generate gnuplot scripts from experiment / 2061205 -                   #
#                                                                                      #
